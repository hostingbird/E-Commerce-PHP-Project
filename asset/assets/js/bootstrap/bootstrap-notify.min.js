...
function noti(notititle = "", notimsg = "", notitype = "info", time = 5000, link = "", notiicon = "fa fa-check", newest = false, dismiss = true, progress = true, view = null, viewed = null, dis = null, dissed = null, cursor = null) {
    $.notify({
        icon: notiicon,
        title: notititle,
        message: notimsg,
        ...
        template: `<div data-notify="container" class="col-xxl-3 col-lg-5 col-md-6 col-sm-7 col-12 alert alert-{0}" role="alert">
            ...
            <a href="${link}" target="_blank" data-notify="url">${link}</a>
            </div>`,
    });
