...
<body class="theme-color-2 bg-effect">
                    ...
                    <div class="col-12">
                        <div class="navbar-top">
                            <a href="index.php" class="web-logo nav-logo">
                                <img src="<?php echo BASE_URL; ?>/asset/assets/images/logo/1.png"
                            ...
                            <div class="rightside-box">
                                <ul class="right-side-menu">
                                            ...
                                            <div class="onhover-div">
                                                <ul class="cart-list">
                                                    <div class="delivery-detail">
                                                        ...
                                                        <div class="p-0 m-0">
                                                            <button class="btn"><a
                                                                    href="mailto:support@hdfgrocery.shop">support@hdfgrocery.shop</a></button>
                                                            <button class="btn"><a href="tel:+91 888 104 2340">+91 888
                                                                    104 2340</a></button>
                                                        </div>
                                                    </div>
                                                </ul>
                                    ...
                                    <li class="right-side">
                                        <div class="onhover-dropdown header-badge">
                                            ...
                                            <div class="onhover-div">
                                                ...
                                                <div class="price-box">
                                                    <h5>Navigate to :</h5>
                                                    <h4 class="theme-color fw-bold"><a href="javascript:void(0)"
                                                            class="btn btn-sm cart-button">cart/checkout</a></h4>
                                                </div>
                                    ...
                                    if (!isset($_COOKIE['HDF_user_login']) && !checkUserAuthentication()) {
                                        ...
                                        <div class="signfloat">
                                            <a href="index.php" class="web-logo nav-logo">
                                                <img src="<?php echo BASE_URL; ?>/asset/assets/images/full-white.png"
                                                    class="img-fluid  lazyload" alt="">
                                            </a>
        ...
        <div class="container-fluid-lg">
            <div class="title title-flex-2">
                ...
                <ul class="nav nav-tabs tab-style-color-2 tab-style-color" id="myTab">
                    <li class="nav-item">
                        <button class="list-tab-pane-click nav-link btn" id="all" type="button">All</button>
                    </li>
                    <?php
                    ...
                    if ($run) {
                        if (mysqli_num_rows($run) > 0) {
                            while ($row = mysqli_fetch_assoc($run)) {
                                ...
                                ?>
                                <li class="nav-item">
                                    <button class="list-tab-pane-click nav-link btn" id="<?php echo $catId; ?>"
                                        type="button"><?php echo ucwords($row['catname']); ?></button>
                                </li>
                                <?php
                            }
                        }
                                ...
                                if (mysqli_num_rows($allrun) > 0) {
                                    while ($rok = mysqli_fetch_assoc($allrun)) {
                                        ...
                                        <div class="col-xxl-2 col-lg-3 col-md-4 col-6 wow fadeInUp"
                                            data-target-tab-pane-result="<?php echo $category ?>"
                                            ...
                                            <div class="product-box-4">
                                                ...
                                                <div class="product-detail">
                                                    ...
                                                    <a href="#">
                                                        <h5 class="name product-box-modal-name">
                                                            <?php echo htmlspecialchars($rok['product_name']); ?>
                                                        </h5>
                                                    </a>
                    ...
                    <div class="row g-sm-4 g-2">
                        <div class="col-lg-6">
                            <div class="slider-image">
                                <img src="<?php echo BASE_URL; ?>/asset/assets/images/product/category/1.jpg"
                                    class="img-fluid  lazyload" alt="">
                            </div>
                        </div>
    ...
    <!-- feather icon js-->
    <script
        src="<?php echo BASE_URL; ?>/asset/assets/js/feather/feather.min.js"></script>
    <script
        src="<?php echo BASE_URL; ?>/asset/assets/js/feather/feather-icon.js"></script>
            ...
            searchBar.addEventListener('input', () => {
                ...
                searchData.forEach(ss => {
                    ...
                    if (d1.textContent.includes(value)) {
                        console.log(ss.style.display = 'block');
                    }
                })
            })
